...
## Project Structure
    ...
    ├── lingering_heart_dev_63674  # Django project configurations
...
1. Clone this repo and `cd lingering_heart_dev_63674`
...
2. Clone this repo and `cd lingering_heart_dev_63674`
